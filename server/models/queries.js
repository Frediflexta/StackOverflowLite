const queries = {
  ...
  getAllQuetions: 'SELECT questions.id, questions.questitle, questions.quesbody, questions.created_at, questions.userid, COUNT(answers.quesid) AS totalAnswers FROM questions LEFT OUTER JOIN answers ON questions.id=answers.quesid GROUP BY questions.id',
