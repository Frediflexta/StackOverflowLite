...
router.post('/questions', auth, Validate.questionCheck, QuesController.postQues);
router.delete('/questions/:qId', auth, QuesController.deleteQues);
router.post('/questions/:qId/answers', auth, Validate.answerCheck, QuesController.postAns);
